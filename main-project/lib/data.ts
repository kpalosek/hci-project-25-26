...
export const cities: City[] = [
  // Croatia
  {
    slug: "zadar",
    name: "Zadar",
    parentCountry: "croatia",
    image:
      "https://images.unsplash.com/photo-1661178434473-6daf1940d913?auto=format&fit=crop&w=800&q=80",
  },
  {
    slug: "split",
    name: "Split",
    parentCountry: "croatia",
    image:
      "https://images.unsplash.com/photo-1564679937942-90c22d5a0e6e?auto=format&fit=crop&w=800&q=80",
  },
  // France
  {
    slug: "paris",
...
export const airports: Airport[] = [
  // Croatia
  {
    iata: "ZAD",
    name: "Zadar Airport",
    locationCitySlug: "zadar",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Zadar_airport_terminal_croatia.JPG/330px-Zadar_airport_terminal_croatia.JPG",
  },
  {
    iata: "SPU",
    name: "Split Airport",
    locationCitySlug: "split",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/a/a0/Split_Airport_new_terminal_night.jpg",
  },
  // France
  {
    iata: "CDG",
    name: "Charles de Gaulle",
    locationCitySlug: "paris",
    image:
      "https://images.unsplash.com/photo-1472664596512-0d00517b6ae0?auto=format&fit=crop&w=800&q=80",
  },
  {
    iata: "BVA",
    name: "Beauvais",
    locationCitySlug: "paris",
    image:
      "https://upload.wikimedia.org/wikipedia/commons/thumb/c/cf/Beauvais_airport_2012_-_panoramio.jpg/1200px-Beauvais_airport_2012_-_panoramio.jpg",
  },
  // USA (Placeholder)
  {
    iata: "JFK",
    name: "John F. Kennedy",
    locationCitySlug: "new-york",
    image:
      "https://images.unsplash.com/photo-1544975331-f15ed1a1c28f?auto=format&fit=crop&w=800&q=80",
  },
  {
    iata: "LGA",
    ...
    locationCitySlug: "new-york",
    image:
      "https://images.unsplash.com/photo-1706963162691-ae2be3d2eff5?auto=format&fit=crop&w=800&q=80",
  },
  {
    iata: "EWR",
    ...
    locationCitySlug: "new-york",
    image:
      "https://images.unsplash.com/photo-1485727511593-8c9f45ea2a06?auto=format&fit=crop&w=800&q=80",
  },
];
  ...
  // --- ZADAR ---
  {
    ...
    transportOptions: [
      ...
      },
      {
        ...
        description:
          "Taxis are located at the exit of the baggage claim area...",
...
* **Platform:** Follow purple signs.
* **Onboard:** Free 4G Wi-Fi.
...
`,
      ...
      },
      {
        id: "subway",
        type: "subway",
        name: "NYC Manhattan Line",
        duration: "30 min",
        price: "€8.00",
        frequency: "Every 10 min",
        description: "Metro starts from Terminal 3 and ends in Penn Station.",
        pros: ["Fastest option", "Avoids traffic", "Cheapest"],
        cons: ["Can be crowded", "Pickpockets warning"],
      },
    ],
...
export const getCountry = (slug: string, parentContinent: string) => {
  return countries.find(
    (c) => c.slug === slug && c.parentContinent === parentContinent
  );
};
...
export const getCity = (slug: string, parentCountry: string) => {
  return cities.find(
    (c) => c.slug === slug && c.parentCountry === parentCountry
  );
};
...
export const getAirport = (iata: string) =>
...
export const getSpecificGuide = (airportIata: string, citySlug: string) => {
  return transferGuides.find(
    (g) => g.airportIata === airportIata && g.targetCitySlug === citySlug
  );
};
...
export const getGuideByAirportAndCity = (
  airportCode: string,
  citySlug: string
) => {
  return transferGuides.find(
